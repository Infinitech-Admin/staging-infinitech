...
export async function GET(
  ...
  try {
    ...
    const res = await fetch(`${apiUrl}/api/website-inquiries/${id}`, {
    ...
    console.error("❌ Fetch Website Inquiry Error:", error);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("❌ Update Website Inquiry Error:", error);
    return NextResponse.json(
      { code: 500, message: "Something Went Wrong" },
      { status: 500 },
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("❌ Delete Website Inquiry Error:", error);
    return NextResponse.json(
      { code: 500, message: "Something Went Wrong" },
      { status: 500 },
    );
